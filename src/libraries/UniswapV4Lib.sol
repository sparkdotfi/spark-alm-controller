...
library UniswapV4Lib {
    ...
    function _increaseLiquidity(
        ...
        require(
            amount0Max * commonParams.maxSlippage <= _clampedSub(startingBalance0, endingBalance0) * 1e18,
            "UniswapV4Lib/amount0Max-too-high"
        );

        require(
            amount1Max * commonParams.maxSlippage <= _clampedSub(startingBalance1, endingBalance1) * 1e18,
